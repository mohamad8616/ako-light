/**
 * Step 1 — IDOR / direct server-action access as a plain `user` role.
 * Part 1 of 3: hermetic mocks (auth, next/*, repositories, result-server).
 */
...
describe("admin actions called directly as plain user", () => {
  ...
  it("products create/update/delete reject a user session", async () => {
  ...
  it("product-categories create/update/delete reject a user session", async () => {
  ...
  it("designers create/update/delete reject a user session", async () => {
  ...
  it("collections create/update/delete reject a user session", async () => {
  ...
  it("materials create/update/delete reject a user session", async () => {
  ...
  it("flagships create/update/delete reject a user session", async () => {
  ...
  it("projects create/update/delete reject a user session", async () => {
  ...
  it("fabrics create/update/delete reject a user session", async () => {
  ...
  it("catalogue create/update/delete reject a user session", async () => {
  ...
  it("homepage singleton updates reject a user session", async () => {
