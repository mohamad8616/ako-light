export const s34Sections = {
  hero: {
    title: "S-34",
    subtitle: "Experience the beauty of timeless design",
  },
  intro: {
    kicker: "WHOM WOULD WE LOVE TO SHARE OUR HOME WITH?",
    paragraphs: [
  ...
  location: {
    title: "S-34",
    address: "Via della Spiga 34, Milan",
  },
  concept: {
    kicker: "A unique concept space",
    image: "https://www.henge07.com/app/uploads/2024/06/Henge_SR24_06-1.jpg",
    paragraphs: [
  ...
  gallery: {
    kicker: "Sequences of enthralling settings",
    paragraphs: [
